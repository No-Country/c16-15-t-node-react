    ...
    return (
        <section className="section-container last-projects">
            ...
            <div className="content-wrapper">
                <a href="https://www.nferias.com/expoagro-0/" className="project-item">
                    <article>
                        <div>
                            <h4>Expoagro 2024</h4>
                        ...
                        <div className="image-container">
                            <img src="https://images.neventum.com/logos/2017/23/160/588773ecc45dc-expoagro.png" alt="Feria 1" />
                        </div>
                    </article>
                </a>
                <a href="https://www.nferias.com/fa-cosa-giusta/" className="project-item">
                    <article>
                        <div>
                        ...
                        <div className="image-container">
                            <img src="https://images.neventum.com/2011/249/b_7648_1d2b2c66.jpg" alt="Feria 2" />
                        </div>
                    </article>
                </a>
                <a href="https://www.nferias.com/automechanika-argentina/" className="project-item">
                    <article>
                        <div>
                        ...
                        <div className="image-container">
                            <img src="https://images.neventum.com/logos/0000/1/160/automechanika_ba_110.jpg" alt="Feria 3" />
                        </div>
                    </article>
                </a>
